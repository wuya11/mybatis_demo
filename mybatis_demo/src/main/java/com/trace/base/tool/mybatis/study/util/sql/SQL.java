...
import static com.trace.base.tool.mybatis.study.util.sql.Where.WhereEnum.AND;
import static com.trace.base.tool.mybatis.study.util.sql.Where.WhereEnum.OR;
...
public final class SQL {
    ...
    private String createSql(ActionType actionType) {
        ...
        switch (actionType) {
            ...
            case UNION_ALL: {
                if (!CollectionUtils.isEmpty(unionAll)) {
    ...
    public SQL where(String where) {
        Validate.notBlank(where, "where must have text");
    ...
    public SQL and(String and) {
        Validate.notBlank(and, "and must have text");
    ...
    public SQL or(String or) {
        Validate.notBlank(or, "or must have text");
        or(new Where(or, OR));
        return this;
    }
    ...
    public SQL or(Where or) {
        Validate.notNull(or, "or can't be null");
        or.whereEnum = OR;
        this.where.add(or);
        return this;
    }
    ...
    public SQL limit(Page page) {
        ...
        if (!page.isAutoCount()&&limit[0] >= page.getTotal()) {
    ...
    public <T> String foreach(List<T> params, SqlIterator<T> sqlIterator) {
        Validate.notEmpty(params, "params can't be empty");
